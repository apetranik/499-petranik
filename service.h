...
class Service final : public chirp::ServiceLayer::Service {
 public:
   Service() : backend_client_(grpc::CreateChannel("localhost:50002", grpc::InsecureChannelCredentials())) {}
   ...
   grpc::Status monitor_check(grpc::ServerContext *context, const chirp::MonitorRequest *request, chirp::Followers* reply);
 private:
   // Helper function - performs DFS on chirp thread to collect all chirps and replies to chirps
